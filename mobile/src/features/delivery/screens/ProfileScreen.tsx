...
export function ProfileScreen({ navigation }: DeliveryScreenProps<'Profile'>) {
          ...
          <View style={{ paddingHorizontal: 16, gap: 10 }}>
            ...
            <View style={{ backgroundColor: colors.surface, borderWidth: 1.5, borderColor: colors.border, borderRadius: 16, padding: 16 }}>
              <View style={{ flexDirection: 'row' as const, alignItems: 'center' as const }}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={{ fontSize: 16, fontWeight: '700' as const, color: colors.text }}>{user?.full_name ?? 'Delivery partner'}</Text>
